...
function salvarItem() {
    ...
    if(checarDuplicado){
        alert("Você está colocando o mesmo item")
    }else{    
        listaDeItens.push({
            valor: comprasItem,
            checar: false
...
function mostrarItem() {
    ...
    // Aqui a gente vai deletar o objeto da lista
    ...
    // Aqui a gente vai editar o objeto da lista

    const editarItens = document.querySelectorAll('.editar')

    editarItens.forEach((i) => {
        i.addEventListener('click', (evento) => {
            itemAEditar = valorDoElemento = evento.target.parentElement.parentElement.getAttribute('data-value')
            mostrarItem()
        })
    })
